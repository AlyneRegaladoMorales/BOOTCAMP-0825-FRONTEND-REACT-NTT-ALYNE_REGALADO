  ...
  return (
    <div>
      ...
      {state.items.length === 0 ? (
        <p style={{ color: "gray" }}>No hay productos en el carrito</p>
      ) : (
        <>
              ...
              {state.items.map((item) => (
                <tr key={item.product.id}>
                  ...
                  <td>
                    <button
                      onClick={() =>
                        dispatch({ type: "DECREMENT", payload: item.product.id })
                      }
                    ...
                    <button
                      onClick={() =>
                        dispatch({ type: "INCREMENT", payload: item.product.id })
                      }
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              />
              {errors.referencia && <p style={{ color: "red" }}>{errors.referencia}</p>}
            </div>
